...
def rnn_step_backward(dnext_h, cache):
    ...
    dtanh = 1 - next_h**2
    dprev_z = dnext_h * dtanh # Shape: (N, H)
    db = np.sum(dprev_z, axis=0)
    dWh = prev_h.T @ dprev_z
    dWx = x.T @ dprev_z
    dx = dprev_z @ Wx.T
    dprev_h =  dprev_z @ Wh.T
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def word_embedding_forward(x, W):
    ...
    ##############################################################################
    N, T = x.shape
    out = np.array([W[x[n]] for n in range(N)])
    cache = (x, W)
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache = x, prev_h, prev_c, Wx, Wh, b, i, f, o, g, a_i, a_f, a_o, a_g, next_c
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    #############################################################################
    x, prev_h, prev_c, Wx, Wh, b, i, f, o, g, a_i, a_f, a_o, a_g, next_c = cache
